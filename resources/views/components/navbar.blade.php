    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarMas">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                @auth
                <li class="nav-item">
                    <x-nav-link href="/dashboard" :active="request()->is('dashboard') ? true : false"><i class="ri-home-5-fill"></i>Dashboard</x-nav-link>
                </li>
                
                    <li class="nav-item">
                        <x-nav-link href="/rental" :active="request()->is('rental') ? true : false"><i class="ri-p2p-fill"></i>Rental saya</x-nav-link>
                    </li>
               
                <li class="nav-item">
                    <x-nav-link href="/kendaraan" :active="request()->is('kendaraan') ? true : false"><i class="ri-car-line"></i>Kendaraan</x-nav-link>
                </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown">
                            <li class="dropdown-item">
                                <a href="" class="nav-link"><i class="ri-account-circle-line"></i>Profile</a>
                            </li>
                            <li class="dropdown-item">
                                <a href="" class="nav-link"><i class="ri-lock-password-line"></i>Ganti Password</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
